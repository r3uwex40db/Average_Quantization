...
from gact_aq.quantizer import Quantizer
from gact_aq.autoprec import AutoPrecision
    ...
    def __init__(self, model):
        ...
        if self.auto_prec:
            self.ap = AutoPrecision(
                ...
                config.work_dir, config.adapt_interval, config.log_interval, aq_bit=config.aq_bit)
