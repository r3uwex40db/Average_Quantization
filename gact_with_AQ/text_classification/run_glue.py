...
import time
import gact_aq
from gact_aq.utils import get_memory_usage, exp_recorder
...
from gact_aq.controller import Controller
import json
...
def parse_args():
    ...
    parser.add_argument("--gactnorm", action="store_true", help="Whether or not to use gactnorm")
...
def main():
    ...
    if args.gact:
        gact_aq.set_optimization_level(args.opt_level, bit=args.bit, aq_bit=args.aq_bit, gactnorm =args.gactnorm)
        #gact.set_optimization_level("L2.2", bit=args.bit, aq_bit=args.aq_bit)
