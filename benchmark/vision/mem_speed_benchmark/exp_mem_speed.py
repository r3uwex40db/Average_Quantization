...
def network_to_command(network):
    return "python3 train.py /scratchpad/datasets/ImageNet --arch ARCH --batch-size BS CONFIG --gpu 0".replace("ARCH", network)
...
if __name__ == "__main__":
    ...
    if args.mode == 'linear_scan':
        ...
        algs = ['exact', 'actnn-L3', 'L3-aq1.0-1.5b', 'L3-aq1.0-1.25b']
